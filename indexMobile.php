...
if ($username != NULL) {
  echo "<script>javascript: alert('test 5')></script>";
  echo '<script>location="myteam.php"</script>';
}
else {
  echo "<script>javascript: alert('test 6')></script>";
  session_destroy();
  ...
  if (isset($_POST['register'])) {
    ...
    $user = $stmt->fetch();
    echo "<script>javascript: alert('test 7')></script>";
    // EMAIL
    ...
    echo "<script>javascript: alert('test 8')></script>";
    // USERNAME
    ...
    echo "<script>javascript: alert('test 9')></script>";
