...
if (isset($_POST['player1'])) {
  echo '<script>  
       if (confirm("Are you sure you wanna sell?")) {
 ...
 else if (isset($_POST['player3'])){
 
 }
 else if (isset($_POST['player4'])){
 
 }
 else if (isset($_POST['player5'])){
        ...
        <table class="playerTable" style="width:100%">
          <tr>
            <td>
              ...
              <p>
                <form class="manage" action="manageTeam.php" method="POST"> 
                  <input class="btn-danger btnManage" type="submit" name="player1" value="Sell"/>
                </form>
              </p>
            </td>
            <td>
            ...
            <td>
              ...
              <p>
                <form class="manage" action="manageTeam.php">
                  <input class="btn-danger btnManage" type="submit" name="player3" value="Sell"/>
                </form>
              </p>
            </td>
            <td>
              ...
              <p>
                <form class="manage" action="manageTeam.php">
                  <input class="btn-danger btnManage" type="submit" name="player4" value="Sell"/>
                </form>
              </p>
            </td>
            <td>
              ...
              <p>
                <form class="manage" action="manageTeam.php">
                  <input class="btn-danger btnManage" type="submit" name="player5" value="Sell"/>
                </form>
              </p>
            </td>
          </tr>
