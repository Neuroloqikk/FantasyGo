...
if (isset($_POST['register'])) {
    ...
    if($pass == $passVerify){
        ...
        $result = $stmt->execute();
            ...
            $mg->sendMessage($domain, array('from'=>'fabioamrodrigues98@gmail.com','to'=> 'blockmaster12@gmail.com','subject' => 'The PHP SDK is awesome!','text' => 'It is so simple to send a message.'))
            catch(Exception $e) {
